...
def generate_conftest_file(benchmark_dir: str) -> str:
    """
    Generate a conftest.py in the benchmark directory containing the
    pytest_benchmark_update_json hook.

    This hook strips raw per-round timing arrays (stats.data) before
    pytest-benchmark writes the JSON results file to disk
...
def generate_benchmark_test_file(
    ...
    explicit_combinations: List[Any] = None,
) -> str:
    """
