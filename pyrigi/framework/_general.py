...
def is_quasi_injective(
    ...
    """
    framework._warn_numerical_coord(is_quasi_injective, numerical)
...
def is_injective(
    ...
    See its documentation for the description of the parameters.
    """
    framework._warn_numerical_coord(is_injective, numerical)
...
def is_congruent_realization(
    ...
    tolerance
        Used tolerance when checking numerically.
    """
    framework._warn_numerical_coord(is_congruent_realization, numerical)
...
def is_equivalent_realization(
    ...
    tolerance
        Used tolerance when checking numerically.
    """
    framework._warn_numerical_coord(is_equivalent_realization, numerical)
    _graph_input_check.is_vertex_order(
        framework._graph, list(other_realization.keys()), "other_realization"
    )
