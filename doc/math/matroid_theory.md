...
Whenever we speak about matroidal properties in the _generic $d$-dimensional rigidity matroid $\mathcal{R}_d$_ of an $n$-vertex graph $G=(V,E)$,
we mean the properties of $E$ in $\mathcal{R}_d(K_n)$.
:::
