...
```{code-cell} ipython3
F1.plot(vertex_labels=False, edge_color = {'black':E1, 'red':E2, 'blue':E3}, vertex_size=10, vertex_color='grey')
F2.plot(vertex_labels=False, edge_color = {'black':E1, 'red':E2, 'blue':E3}, vertex_size=10, vertex_color='grey')
```
